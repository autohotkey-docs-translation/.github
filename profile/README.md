# How to contribute
1. Ask Ragnar-F to get write access to a project ([forum PM](https://www.autohotkey.com/boards/ucp.php?i=pm&mode=compose&u=108)). If a project does not yet exist for your language, it will be created.
